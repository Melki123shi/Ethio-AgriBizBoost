...
void main() {
  ...
  group('🔥 Authentication Edge Cases & Advanced Scenarios', () {
    ...
    group('Race Conditions & Concurrency', () {
      testWidgets('should handle rapid form submissions gracefully', (tester) async {
      ...
      testWidgets('should handle concurrent login and signup navigation', (tester) async {
        await tester.pumpWidget(IntegrationTestApp.createApp());
        await tester.pumpAndSettle();
    ...
    group('Memory & Performance Edge Cases', () {
      testWidgets('should handle extremely long input gracefully', (tester) async {
        await tester.pumpWidget(IntegrationTestApp.createApp());
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle special Unicode characters in all fields', (tester) async {
        mockAdapter.addResponse(
          '/auth/register',
          201,
          MockApiResponses.successfulSignup()
        );
    ...
    group('Network Edge Cases', () {
      ...
      testWidgets('should handle intermittent network failures', (tester) async {
        await tester.pumpWidget(IntegrationTestApp.createApp());
        await tester.pumpAndSettle();
    ...
    group('State Management Edge Cases', () {
      testWidgets('should handle app lifecycle changes during auth', (tester) async {
        mockAdapter.addResponse(
          '/auth/login-with-json',
          200,
          MockApiResponses.successfulLogin()
    ...
    group('Security Edge Cases', () {
      testWidgets('should sanitize SQL injection attempts in inputs', (tester) async {
        mockAdapter.addResponse(
          '/auth/register',
          201,
          MockApiResponses.successfulSignup()
      ...
      testWidgets('should handle XSS attempts in display fields', (tester) async {
        await tester.pumpWidget(IntegrationTestApp.createApp());
        await tester.pumpAndSettle();
    ...
    group('Data Validation Boundary Cases', () {
      testWidgets('should handle all Ethiopian telecom prefixes', (tester) async {
        await tester.pumpWidget(IntegrationTestApp.createApp());
        await tester.pumpAndSettle();
      ...
      testWidgets('should validate password edge cases', (tester) async {
        ...
        expect(
          find.text(AuthTestData.passwordValidationError),
          findsNothing
        );
